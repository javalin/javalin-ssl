...
public abstract class IntegrationTestClass {
    ...
    public static final String NORWAY_JKS_KEY_STORE_NAME = "norway.jks";
    public static final String NORWAY_P12_KEY_STORE_NAME = "norway.p12";
