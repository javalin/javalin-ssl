...
public class Server {
    ...
    public static final String CERTIFICATE_FILE_NAME = "server/cert.crt";
    public static final String ENCRYPTED_KEY_FILE_NAME = "server/encrypted.key";
    public static final String NON_ENCRYPTED_KEY_FILE_NAME = "server/passwordless.key";
    ...
    public static final String JKS_KEY_STORE_NAME = "server/keystore.jks";
    ...
    public static final String P12_KEY_STORE_NAME = "server/keystore.p12";
    ...
    public static final String NORWAY_JKS_KEY_STORE_NAME = "server/norway.jks";
    public static final String NORWAY_P12_KEY_STORE_NAME = "server/norway.p12";
    public static final String JKS_KEY_STORE_PATH;
    public static final String P12_KEY_STORE_PATH;
    public static final String NORWAY_JKS_KEY_STORE_PATH;
    public static final String NORWAY_P12_KEY_STORE_PATH;
    ...
    static {
        try {
            NORWAY_JKS_KEY_STORE_PATH = Path.of(ClassLoader.getSystemResource(NORWAY_JKS_KEY_STORE_NAME).toURI()).toAbsolutePath().toString();
        } catch (URISyntaxException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    static {
        try {
            NORWAY_P12_KEY_STORE_PATH = Path.of(ClassLoader.getSystemResource(NORWAY_P12_KEY_STORE_NAME).toURI()).toAbsolutePath().toString();
        } catch (URISyntaxException e) {
            throw new RuntimeException(e);
        }
    }
